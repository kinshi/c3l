...
extern void (*setPixel)(uchar *, ushort, uchar);
extern void (*clearPixel)(uchar *, ushort, uchar);
extern void (*drawLineH)(uchar *, ushort, uchar, ushort, uchar);
extern void (*drawLineV)(uchar *, ushort, uchar, ushort, uchar);
